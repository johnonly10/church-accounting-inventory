...
@section('content')
    <div class="container-fluid p-0">
        ...
        <x-white-card title="Back to Index Page" :home-route="route('staff.revenue-types.index')" :showFilters="true" :filterProps="[
            'searchPlaceholder' => 'Search Archived Revenue Type...',
        ]">
                            ...
                            @forelse ($revenue_types as $revenue_type)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <x-icons.action-form :route="route('staff.revenue-types.restore', $revenue_type->id)"
