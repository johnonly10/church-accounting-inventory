...
@section('content')
    <div class="container-fluid p-0">
        ...
        <x-white-card title="Back to Index Page" :home-route="route('staff.categories.index')" :showFilters="true" :filterProps="[
            'searchPlaceholder' => 'Search Archived name or code...',
                            ...
                            @forelse ($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <x-icons.action-form :route="route('staff.categories.restore', $category->id)"
