...
@section('content')
    <div class="container-fluid p-0">
        ...
        <x-white-card title="Position" :create-route="route('staff.positions.create')" :archive-route="route('staff.positions.archived')" :showFilters="true" :filterProps="[
            'searchPlaceholder' => 'Search by Positions...',
        ]">
