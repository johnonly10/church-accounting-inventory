...
@section('content')
    <div class="container-fluid p-0">
        ...
        <x-white-card title="Back to Index Page" :home-route="route('staff.positions.index')">
                        ...
                        @forelse ($positions as $position)
                            <tr>
                                ...
                                <td class="text-center">
                                    <x-icons.action-form :route="route('staff.positions.restore', $position->id)" aClass="btn btn-sm btn-outline-success border-0"
