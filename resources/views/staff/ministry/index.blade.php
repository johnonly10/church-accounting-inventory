...
@section('content')
    <div class="container-fluid p-0">
        ...
        <x-white-card title="Ministry" :create-route="route('staff.ministries.create')" :archive-route="route('staff.ministries.archived')" :showFilters="true" :filterProps="[
            'searchPlaceholder' => 'Search by Ministries...',
        ]">
