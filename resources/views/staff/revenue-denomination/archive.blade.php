                            ...
                            @forelse ($revenueCashCounts as $row)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <x-icons.action-form :route="route('staff.revenue-cash-counts.restore', $row->id)"
                                            aClass="btn btn-sm btn-outline-success border-0" title="Restore"
                                            icon="fas fa-undo" name="restore" />
                                        <x-icons.action-form :route="route('staff.revenue-cash-counts.forceDelete', $row->id)" icon="fas fa-trash" title="Delete"
