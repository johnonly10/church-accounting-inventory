...
@section('content')
    <div class="container-fluid p-0">
        <x-page-title title="Edit Leader's Information" active="Edit Leader's Information" home="Leaders" :home-route="route('staff.leaders.index')" />
            ...
            <div class="col-lg-12">
                <div class="white_card card_height_100 mb_30">
                    ...
                    <x-white-card-header title="Leader's Information"
                        subTitle="Edit the details to fill the leader information" />

                    <div class="white_card_body">
                        <div class="card-body pt-4">

                            <form action="{{ route('staff.leaders.update', $leader) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nickname', $leader->nickname) }}" required>
                                            @error('nickname')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('cell_name', $leader->cell_name) }}" required>
                                            @error('cell_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <x-buttons.form-action primaryTitle="Update Leader" primaryId="updateLeaderBtn"
