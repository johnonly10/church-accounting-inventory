...
@section('content')
    <div class="container-fluid p-0">
        ...
        <x-white-card title="Back to Index Page" :home-route="route('staff.leaders.index')" :showFilters="true" :filterProps="[
                            ...
                            @forelse ($leaders as $leader)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <x-icons.action-form :route="route('staff.leaders.restore', $leader->id)" icon="fas fa-undo" title="Restore"
                                            name="restore" aClass="btn btn-sm btn-outline-success border-0" />
