...
@section('content')
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-4">
                        Founded in {{ config('church.founded_year', '2024') }}, {{ config('app.name') }} is a
                        Christ-centered
                    ...
                    <p class="text-lg text-gray-600 mb-4">
                        ...
                        community. Whether you’re new to faith or have walked with Christ for years, you are welcome here.
                    </p>
                    <p class="text-lg text-gray-600">
                        Our prayer is simple: that our city would know the hope of the gospel through worship, discipleship,
                        and compassionate service.
                    </p>

                    {{-- Optional quick highlights (remove if you don't need it) --}}
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                    ...
                    <div class="rounded-xl bg-white p-5 border border-gray-200">
                        ...
                        <p class="text-gray-600">
                            A gospel-shaped church that multiplies disciples, leaders, and ministries for the glory of God.
                        </p>
                    </div>
                </div>
            </div>
            ...
            {{-- Optional: Beliefs summary (remove if you prefer a separate "What We Believe" page) --}}
            <div class="bg-gray-50 rounded-2xl p-8">
                <h3 class="text-2xl font-bold text-gray-900 mb-3">What We Believe</h3>
                <p class="text-gray-600 mb-4">
                    We believe in one God—Father, Son, and Holy Spirit. We believe Jesus Christ is Lord, fully God and fully
                    man, and that salvation is by grace through faith. We believe the church is called to worship, disciple,
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                {{-- Replace names/titles/photos as needed --}}
                <div class="text-center">
                    <div class="w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full mx-auto mb-4"></div>
                    <h3 class="text-lg font-semibold text-gray-900">Pastor Name</h3>
                    <p class="text-gray-600">Lead Pastor</p>
                </div>

                <div class="text-center">
                    <div class="w-32 h-32 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-full mx-auto mb-4"></div>
                    <h3 class="text-lg font-semibold text-gray-900">Pastor Name</h3>
                    <p class="text-gray-600">Associate Pastor</p>
                </div>

                <div class="text-center">
                    <div class="w-32 h-32 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full mx-auto mb-4"></div>
                    <h3 class="text-lg font-semibold text-gray-900">Leader Name</h3>
                    <p class="text-gray-600">Worship Leader</p>
                </div>

                <div class="text-center">
                    <div class="w-32 h-32 bg-gradient-to-br from-pink-400 to-pink-600 rounded-full mx-auto mb-4"></div>
                    <h3 class="text-lg font-semibold text-gray-900">Leader Name</h3>
