                            ...
                            <form action="{{ route('leader.pepsol-names.update', $pepsolName->id) }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                                ...
                                                @if ($pepsolName->image)
                                                    <div class="border rounded-3 p-3 bg-light text-center">
                                                        <img src="{{ asset('Images/Pepsol/Name/' . $pepsolName->image) }}"
                                                            alt="{{ $pepsolName->name }}" class="img-fluid rounded"
                                                            style="max-height: 200px; object-fit: contain;">
                                                        <p class="mt-2 mb-0">
                                                            <small class="text-muted">
                                                                <i class="bi bi-file-image me-1"></i>
                                                                Current: {{ $pepsolName->image }}
                                                            </small>
                                                        </p>
                                                    </div>
                                                @else
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                <label class="form-label fw-semibold d-block">Change Image <span
                                                ...
                                                <div class="position-relative">
                                                    <button type="button" class="btn btn-outline-primary w-100"
                                                        ...
                                                        <span id="uploadBtnText">Choose New Image</span>
                                                    </button>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="border rounded-3 bg-light position-relative overflow-hidden"
                                                    ...
                                                    <div class="d-flex flex-column align-items-center justify-content-center h-100 p-4"
                                                        ...
                                                        <p class="text-muted mt-2 mb-0">No new image selected</p>
                                                        <small class="text-muted">Upload a new image to see preview</small>
                                                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function resetFileUI() {
                    imageInput.value = '';
                    uploadBtnText.textContent = 'Choose New Image';
