                ...
                <div class="white_card card_height_100 mb_30">
                    ...
                    <div class="white_card_body">
                        <div class="card-body pt-4">
                            <form action="{{ route('leader.pepsol-types.update', $pepsolType->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            ...
                                            value="{{ old('name', $pepsolType->name) }}" required>
                                        @error('name')
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('code') is-invalid @enderror"
                                                ...
                                                value="{{ old('code', $pepsolType->code) }}" required>
                                            @error('code')
                                                <div class="invalid-feedback"> {{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <x-buttons.form-action primaryTitle="Update Type " primaryId="updateTypeBtn"
