...
@section('content')
    <div class="container-fluid p-0">
        <x-page-title title="Create Image" active="Create Images" :home-route="route('leader.images.index')" home="Images" />

        <x-white-card title="Create Image" :back-route="route('leader.images.index')">
            <form action="{{ route('leader.images.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        <x-buttons.form-action primaryTitle="Create Image" primaryId="createImagesBtn" :cancel-route="route('leader.images.index')" />
                    </div>
