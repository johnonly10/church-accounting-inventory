...
@section('content')
    ...
    <div id="lp-page">
        <div class="lp-card">
            <h1 class="lp-card-title">Reset your password</h1>
            <p class="lp-card-sub">Enter your email and we'll send you instructions to reset your password.</p>
            ...
            <form method="POST" action="{{ route('password.email') }}" id="forgotForm" novalidate>
                ...
                <button type="submit" class="lp-btn-submit" id="submitBtn">
                    <span class="lp-btn-text">Send reset link</span>
